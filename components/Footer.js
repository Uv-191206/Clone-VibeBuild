            ...
            <div style={{ maxWidth: 1200, margin: '0 auto', padding: '3rem 1.5rem 1.5rem' }}>
                        ...
                        <div style={{ display: 'grid', gap: '0.75rem' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', gap: '0.75rem' }}>
                                    ...
                                    <a href="https://github.com/Uv-191206" target="_blank" rel="noopener noreferrer" style={{ color: '#333', fontSize: '0.78rem', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 5, fontWeight: 500 }}>
                ...
                <div style={{
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', margin: 0, display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        Proudly vibecoded by <a href="https://github.com/Uv-191206" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-blue)', fontWeight: 600, textDecoration: 'none', marginLeft: 4 }}>25EC students.</a>
                    </p>
                </div>
            </div>
        </footer>
